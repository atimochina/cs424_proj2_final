...
server <- function(input, output) {
    ...
    output$catInfo1 <- renderUI(HTML(
        paste(
            ...
            "The Saffir-Simpson Hurricane Wind Scale classifies hurricanes â Western Hemisphere tropical cyclones â 
            that exceed the intensities of tropical depressions <b>TD</b> (<38 mph) and tropical storms <b>TS</b> (39-73 mph)
            â into five categories distinguished by the intensities of their sustained winds."
        )
    ))
